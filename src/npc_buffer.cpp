...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Achievement_BG_KillFlagCarriers_grabFlag_CapIt:25|t全属性BUFF！", GOSSIP_SENDER_MAIN, 1);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Temp:25|t再见", GOSSIP_SENDER_MAIN, 999);
